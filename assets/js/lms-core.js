...
(function () {
    ...
    const DEFAULT_CLOUD_CONFIG = {
        ...
        cloudJsonStudentsUrl: "", // Public/Private Cloud JSON Endpoint (e.g. npoint.io, jsonbin.io, or custom REST URL)
        cloudJsonConfigUrl: "",
    ...
    window.LMSCore = {
        ...
        async pushToCloud(type, payload) {
            ...
            // 1. Cloud JSON REST Endpoint (PUT JSON)
            const targetUrl = (type === 'students') ? cloud.cloudJsonStudentsUrl : cloud.cloudJsonConfigUrl;
            if (targetUrl && targetUrl.trim() !== '') {
                try {
                    ...
                    console.log(`Pushed JSON update to Cloud JSON Endpoint (${type})`);
                } catch (err) {
                    console.error("Cloud JSON PUT error:", err);
                }
            }
